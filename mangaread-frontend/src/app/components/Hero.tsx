...
const Hero = () => {
  ...
  return (
    <section className="relative bg-cover bg-center h-auto md:p-12 py-12 sliding-background" style={{ 
      ...
      <div className="absolute inset-0 bg-slate-950 dark:bg-black bg-opacity-65 dark:bg-opacity-60"></div>
      <div className="relative container mx-auto px-6 lg:px-12 flex items-center justify-center h-full">
        <div className="text-center text-white">
          ...
          <div className='flex justify-center items-center gap-4'>
            ...
            {isSignedIn ? (
              <button>
                <a href="/upload" className="inline-block text-sm bg-green-600 hover:bg-green-700 text-white font-bold py-2 md:py-3 px-6 rounded-lg transition duration-300 ease-in-out border border-black">Upload Manga</a>
              </button>
            ) : (
              <button>
                <a href="/login" className="inline-block text-sm bg-red-600 hover:bg-red-700 text-white font-bold py-2 md:py-3 px-6 rounded-lg transition duration-300 ease-in-out border border-black">Signin to upload</a>
              </button>
            )}
          </div>
        </div>
